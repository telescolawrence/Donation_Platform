...
const DONATION_CANISTER_ID = "be2us-64aaa-aaaaa-qaabq-cai";
const LEDGER_CANISTER_ID = "ryjl3-tyaaa-aaaaa-aaaba-cai";
const HOST = "http://localhost:4943";

export async function getDonationCanister() {
    return await getCanister(DONATION_CANISTER_ID, marketPlaceIDL);
}
